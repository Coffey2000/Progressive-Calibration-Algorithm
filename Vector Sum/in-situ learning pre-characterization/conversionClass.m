classdef conversionClass
    methods (Static)
        ...
        function [vector1_index, vector2_index] = vectorLength2index(L1, L2)
            global vector1_profile vector2_profile vector1_envelop_profile vector2_envelop_profile reference_index VECTOR_PROFILE_SIZE
            ...
            vector_profile_reference_index = vector1_profile(:, 1) == reference_index(1);
            scaled_vector1_profile(1:vector_profile_reference_index - 1, 2) = scaled_vector1_profile(1:vector_profile_reference_index - 1, 2)*vector1Length_scaling_minus;
            scaled_vector1_profile(vector_profile_reference_index + 1:VECTOR_PROFILE_SIZE, 2) = scaled_vector1_profile(vector_profile_reference_index + 1:VECTOR_PROFILE_SIZE, 2)*vector1Length_scaling_plus;

            scaled_vector2_profile = vector2_profile;
            vector_profile_reference_index = vector2_profile(:, 1) == reference_index(2);
            scaled_vector2_profile(1:vector_profile_reference_index - 1, 2) = scaled_vector2_profile(1:vector_profile_reference_index - 1, 2)*vector2Length_scaling_minus;
            scaled_vector2_profile(vector_profile_reference_index + 1:VECTOR_PROFILE_SIZE, 2) = scaled_vector2_profile(vector_profile_reference_index + 1:VECTOR_PROFILE_SIZE, 2)*vector2Length_scaling_plus;
