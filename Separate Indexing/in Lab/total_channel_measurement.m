...
channel_readings_38GHz_test = zeros(256, 256, 1);
...
for gain_index = 1:1:256
    for phase_index = 1:1:256
        ...
        channel_readings_38GHz_test(gain_index, phase_index, 1) = Pna.getSParameters;
    end
end
time = toc;
...
save("channel_readings_38GHz_test.mat", "channel_readings_38GHz_test");
